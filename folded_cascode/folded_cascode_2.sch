...
C {devices/lab_pin.sym} -450 440 2 0 {name=p10 sig_type=std_logic lab=VCC}
C {devices/isource.sym} -450 470 0 0 {name=I2 value=15u}
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} -340 150 0 1 {name=M15
L=0.5
W=50
nf=1
mult=1
...
C {devices/lab_pin.sym} -360 120 1 0 {name=p15 sig_type=std_logic lab=VCC}
C {devices/isource.sym} -360 210 0 0 {name=I3 value=30u}
C {devices/lab_pin.sym} -360 240 3 0 {name=p16 sig_type=std_logic lab=VSS}
...
C {devices/vsource.sym} 280 80 0 0 {name=V1 value=0.9}
